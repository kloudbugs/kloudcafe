...
import '../components/C12Platform.css';

const C12Platform: React.FC = () => {
            ...
            <section className="c12-hero">
              ...
              <div className="c12-hero-content">
                <div className="c12-hero-text">
                  <p>C12 is a revolutionary platform that leverages blockchain technology to promote social justice causes through digital mining operations. Our mission is to honor the voices of those who can no longer speak for themselves.</p>
